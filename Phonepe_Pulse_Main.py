...
st.set_page_config(page_title="Phonepe Pulse Data Visualization | By Nivetha Loganathan",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This dashboard app is created by *Nivetha Loganathan*!
